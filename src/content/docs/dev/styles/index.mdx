...
:::note
Originally, Limbo was being designed with Tailwind and utility classes. However, it became clear that, although this was a very easy solution many developers understand, it would not allow a truly customizable experience.

We believe that, although it may be a trend back in web design, that semantic CSS (and semantic markup where we can) is the way forward for apps like Limbo.
:::
